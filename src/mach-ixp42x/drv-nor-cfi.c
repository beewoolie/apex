...
typedef unsigned short array_t;
...
static ssize_t nor_read (struct descriptor_d* d, void* pv, size_t cb)
{
  ...
  printf ("nor flash read ");
  printf (" %x %x", NOR_0_PHYS, REGA (NOR_0_PHYS));
  printf (" %x %x", NOR_0_PHYS + 0x20000, REGA (NOR_0_PHYS + 0x20000));
  printf (" %x %x\n", NOR_0_PHYS + 0x40000, REGA (NOR_0_PHYS + 0x40000));
#endif
