...
"  When the DRIVER is absent, the default memory: driver is used.\n"
"  The drvinfo command will display a list of available drivers.\n" 
"  The START value may be in hexadecimal, decimal, or decimal with\n"
"  a multipler, e.g. 10k for kilobytes, 1m for megabytes.  The \n"
