...
#if !defined (FREESCALE_MX53_LOWCOST_H_INCLUDED)
#    define   FREESCALE_MX53_LOWCOST_H_INCLUDED

/* ----- Includes */

#include <linux/types.h>
#include "mx51-pins.h"          /* *** FIXME */
...
/* *** FIXME: there is a good chance that none of these pin
...
#endif  /* FREESCALE_MX53_LOWCOST_H_INCLUDED */
